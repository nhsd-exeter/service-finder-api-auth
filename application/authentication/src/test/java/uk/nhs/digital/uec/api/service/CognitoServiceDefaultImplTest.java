 ...
 */
public class CognitoServiceDefaultImplTest {
    ...
    public void setUp() {
        ...
        service = new CognitoServiceDefaultImpl(amazonCognitoIdentityClient, cognitoUserPoolProperties, factory,
    ...
    public void shouldAuthenticate() throws InvalidLoginException {
        ...
        InitiateAuthRequest authenticationRequest = getAdminInitiateAuthRequest(AuthFlowType.USER_PASSWORD_AUTH,
    ...
    public void shouldAuthenticateWithRefreshToken() {
        ...
        InitiateAuthRequest authenticationRequest = getAdminInitiateAuthRequest(AuthFlowType.REFRESH_TOKEN_AUTH,
                authenticationParameters);
        InitiateAuthResult authenticationResult = new InitiateAuthResult();
        authenticationResult
                .setAuthenticationResult(atestAuthenticationResultType().withRefreshToken(REFRESH_TOKEN_VALUE).build());
    ...
    @Test
    public void authenticateShouldThrowUserManagementExceptionGivenAwsCognitoIdentityProviderException()
    ...
    @Test
    public void authenticateShouldThrowInvalidCredentialsExceptionGivenUserNotFoundException()
            throws InvalidLoginException {
        // Given
    ...
    private InitiateAuthRequest getAdminInitiateAuthRequest(AuthFlowType authFlowType,
