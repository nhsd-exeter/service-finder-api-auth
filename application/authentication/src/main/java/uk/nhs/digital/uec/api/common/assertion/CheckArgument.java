package uk.nhs.digital.uec.api.common.assertion;
...
/**
 * Assertions for checking arguments passed to a method. Any assertions that fail<br/> will result in an {@link IllegalArgumentException} being thrown.
 */
public class CheckArgument {
     ...
     * @param exceptionMessage Message explaining the argument must not be {@code null}, must have text
     * @throws IllegalArgumentException Thrown if the argument is {@code null}
     */
    public static void isNotNull(Object argument, String exceptionMessage) throws IllegalArgumentException {
     ...
     */
    public static void hasEntries(Map<?, ?> argument, String exceptionMessage) throws IllegalArgumentException {
     ...
     * @param exceptionMessage Message explaining the argument must have text and must not be {@code null}, must have text
     * @throws IllegalArgumentException Thrown if the {@link String} argument does not have text or is {@code null}
     */
    public static void hasText(String argument, String exceptionMessage) throws IllegalArgumentException {
        isNotNull(argument, exceptionMessage);
     ...
     */
    public static void isOneOf(Object object, String exceptionMessage, Object... validValues) throws IllegalArgumentException {
    ...
    /**
     * @param argument {@link Number} we want to check is greater than or equal to {@code minimum}, must not be {@code null}
     * @param minimum {@link Number} we want to check {@code argument} is greater than or equal to, must not be {@code null}
     * @param exceptionMessage Message explaining the argument must be greater than or equal to the minimum, must have text
     * @param <T> a number type
     * @throws IllegalArgumentException Thrown if the argument is less than the minimum
     */
    public static <T extends Number & Comparable<T>> void isGreaterThanOrEqualTo(T argument, T minimum, String exceptionMessage)
    ...
    /**
     * @param argument {@link Number} we want to check is less than or equal to {@code maximum}, must not be {@code null}
     * @param maximum {@link Number} we want to check {@code argument} is less than or equal to, must not be {@code null}
     * @param exceptionMessage Message explaining the argument must be less than or equal to the maximum, must have text
     * @param <T> a number type
     * @throws IllegalArgumentException Thrown if the argument is greater than the maximum
     */
    public static <T extends Number & Comparable<T>> void isLessThanOrEqualTo(T argument, T maximum, String exceptionMessage) throws IllegalArgumentException {
        isNotNull(argument, exceptionMessage);
     ...
     * @param exceptionMessage Message explaining the argument must be zero or positive, must have text
     * @throws IllegalArgumentException Thrown if the argument is negative
     */
    public static void matches(String argument, String regex, String exceptionMessage) throws IllegalArgumentException {
        isNotNull(argument, exceptionMessage);
