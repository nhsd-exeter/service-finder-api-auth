package uk.nhs.digital.uec.api.common;
...
public class CookieTokenExtractor implements TokenExtractor {
    ...
    /**
     * Extracts the ACCESS and REFRESH tokens from the request and passes them back out as a
    ...
    public static AuthenticationToken extractAuthenticationToken(final HttpServletRequest request)
    {
        return new AuthenticationToken(
            extractToken(request, ACCESS_TOKEN),
            extractToken(request, REFRESH_TOKEN));
    }
