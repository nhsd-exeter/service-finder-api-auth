...
@ControllerAdvice
public class AuthApiControllerAdvice extends ResponseEntityExceptionHandler {
  ...
  public ResponseEntity<ErrorMessage> invalidParameterException(InvalidParameterException ex, WebRequest request) {
    ErrorMessage message = new ErrorMessage(
