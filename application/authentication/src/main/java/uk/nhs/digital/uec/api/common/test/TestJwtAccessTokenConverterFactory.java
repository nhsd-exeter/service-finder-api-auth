package uk.nhs.digital.uec.api.common.test;
...
/**
 * Used only in apiTest and integrationTest environments to verify access tokens against a pre-configured public key.
