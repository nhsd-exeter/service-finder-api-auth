...
public class CognitoClientRequestSecretHashFactory {
     ...
     * @throws CognitoClientSecretHashException if the generation of the secret hash failed due to an invalid key or an unknown cryptographic algorithm provided
     */
