...
import static uk.nhs.digital.uec.api.util.Constants.REFRESH_TOKEN;
import static uk.nhs.digital.uec.api.util.Constants.REFRESH_TOKEN_AUTH;
import static uk.nhs.digital.uec.api.util.Constants.USERNAME;
import static uk.nhs.digital.uec.api.util.Constants.USER_PASSWORD_AUTH;
...
@Service
@Slf4j
public class CognitoIdpService implements CognitoIdpServiceInterface {
  ...
  public AuthToken authenticate(String refreshToken, String email) throws UnauthorisedException {
    Map<String, String> authenticationParameters = Map.of(REFRESH_TOKEN, refreshToken,
  ...
  private AuthToken getAuthenticationTokens(
    ...
    return AuthToken.builder().accessToken(authenticationResult.getAuthenticationResult().getAccessToken())
        .refreshToken(authenticationResult.getAuthenticationResult().getRefreshToken())
        .build();
  }
